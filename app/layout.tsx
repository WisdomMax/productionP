      ...
      <head>
        <script
          dangerouslySetInnerHTML={{
            __html: `(()=>{if("scrollRestoration"in history)history.scrollRestoration="auto";const nav=performance.getEntriesByType("navigation")[0];if(location.pathname==="/"&&nav?.type!=="back_forward")scrollTo(0,0);if(new URLSearchParams(location.search).get("skipIntro")==="1")document.documentElement.dataset.introSeen="true"})();`,
          }}
        />
      </head>
      <body>
